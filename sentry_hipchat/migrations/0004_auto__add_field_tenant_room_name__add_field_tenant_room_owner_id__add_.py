...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tenant.room_name'
        db.add_column(u'sentry_hipchat_tenant', 'room_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'Tenant.room_owner_id'
        db.add_column(u'sentry_hipchat_tenant', 'room_owner_id',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True),
                      keep_default=False)

        # Adding field 'Tenant.room_owner_name'
        db.add_column(u'sentry_hipchat_tenant', 'room_owner_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tenant.room_name'
        db.delete_column(u'sentry_hipchat_tenant', 'room_name')

        # Deleting field 'Tenant.room_owner_id'
        db.delete_column(u'sentry_hipchat_tenant', 'room_owner_id')

        # Deleting field 'Tenant.room_owner_name'
        db.delete_column(u'sentry_hipchat_tenant', 'room_owner_name')
